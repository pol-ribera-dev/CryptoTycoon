...
contract Deploy is Script {
    ...
    function run() external returns(MainGym){
        ...
        MainGym tycoon = new MainGym(tokenName, tokenSymbol, NFTName, NFTSymbol, baseUri, feeRefund, upgradePeriodPerLvl, boostPercentagePerLvl, baseProductionPerLvl, relationPriceProduction, maxLvlBase, maxLvlMulti, amountBase, amountMulti);
